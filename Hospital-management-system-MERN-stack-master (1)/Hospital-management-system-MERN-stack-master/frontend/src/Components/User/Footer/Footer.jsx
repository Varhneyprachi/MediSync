...
function Copyright(props) {
    return (
        <Typography variant="body2" color="text.secondary" align="center" {...props}>
            {'Developed with 🖤 by '}
            <strong><a className='text-style' href="#" target="_blank" rel="noreferrer noopener">YourName</a></strong>
            {' Copyright © '}
                    ...
                    <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                        ...
                        <Grid sx={{ m: 'auto' }} item xs={12} sm={6} md={4}>
                            ...
                            <Stack direction="row" justifyContent="flex-start" alignItems="center" spacing={1}>
                                ...
                                <a className='text-style' href="mailto:varshneyprachi26@gmail.com">
                                    varshneyprachi26@gmail.com
                                </a>
                            </Stack>
                            ...
                            <Stack direction="row" justifyContent="flex-start" alignItems="center" spacing={1}>
                                ...
                                <a className='text-style' href="tel:+91-8445805005">
                                    +91-8445805005
                                </a>
                            </Stack>
                        </Grid>
                        ...
                        <Grid item xs={12} sm={4}>
                            ...
                            <Stack direction="row" justifyContent="flex-start" alignItems="center" spacing={1}>
                                ...
                                <a className='text-style' href="http://www.linkedin.com/in/prachivarshney26" target="_blank" rel="noopener noreferrer">
                                    LinkedIn
                                </a>
                            </Stack>
                            ...
                            <Stack direction="row" justifyContent="flex-start" alignItems="center" spacing={1}>
                                ...
                                <a className='text-style' href="https://github.com/Varhneyprachi" target="_blank" rel="noopener noreferrer">
                                    GitHub
                                </a>
                            </Stack>
                        </Grid>
